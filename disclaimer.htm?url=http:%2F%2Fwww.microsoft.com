  ...
  <table width=90% border=0>
    <tr>
      <td>
        ...
        <a href="./disclaimer.htm?url=http:%252F%252Fwww.microsoft.com#" onclick="go();return false;"><img src="images/ok.gif" id="ok" alt="ok" border="0"></a>
        <a href="./disclaimer.htm?url=http:%252F%252Fwww.microsoft.com#" onclick="cl();return false;"><img src="images/cancel.gif" id="cancel" alt="cancel" border="0"></a>
      </td>
    </tr>
  </table>
